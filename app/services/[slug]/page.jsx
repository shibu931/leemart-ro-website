        ...
        <section>
          <div className="container bg-white rounded-lg border-2 p-3 md:p-6 lg:p-10">
            <div className="grid grid-cols-1 md:grid-cols-8 gap-5 lg:gap-10">
              ...
              <div className="col-span-1 md:col-span-5 my-auto text-justify">
                <span className='text-xl text-blue-600 font-semibold block mb-3'>Improving Water Quality:</span>
                <h1 className='text-4xl font-bold text-blue-950 mb-5'>Leemart's All-Inclusive RO Water Purifier Maintenance, Setup, & Services</h1>
                ...
                <h2 className="mb-5 text-3xl font-bold text-blue-950">Full Range of Services Provided by Leemart</h2>
                ...
                <h3 className="mb-5 text-3xl font-bold text-blue-950">A Customer-First Mentality</h3>
                ...
                <h3 className="mb-5 text-3xl font-bold text-blue-950">Conclusion</h3>
